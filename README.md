...
AI-powered VS Code extension for smart prompt refinement and code explanation.

## ⚠️ Critical Production Environment Variables

**These MUST be set in production for trials to work:**
...
# Critical: Set in Supabase Dashboard → Settings → Environment Variables
...
**Must configure these webhooks in Stripe Dashboard:**
- `checkout.session.completed` 
- `customer.subscription.updated` ← **Critical for trial transitions**
